    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon_name', models.CharField(default='', help_text='Icon name class from the fontawesome icon set, or custom SVG icomoon icon class.  See fontawesome version 6 documentation for more info.  Custom icomoon icons can be viewed and added to the gdex custom icon set by adding the SVG to the static/unity/lib/icomoon2/ directory and including the icon class name here.', max_length=50, verbose_name='Icon')),
