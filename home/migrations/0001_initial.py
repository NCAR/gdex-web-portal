# Generated by Django 5.2 on 2026-01-13 22:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='GDEXPage',
            fields=[
                ('page_ptr', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='%(app_label)s_%(class)s_related', serialize=False, to='wagtailcore.page')),
                ('menu_title', models.CharField(blank=True, default='', help_text='Short title to use in the navigation bar menu.  If blank, the page title will be used.', max_length=50)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_label', models.CharField(blank=True, default='Learn More', help_text='Specify label for related link or URL', max_length=100)),
                ('related_url', models.URLField(blank=True, help_text='Optional.  Related page takes precedence over related URL.', null=True)),
                ('start_date', models.DateField(default=datetime.date(2026, 1, 13), verbose_name='Start date')),
                ('end_date', models.DateField(default=datetime.date(2026, 1, 13), verbose_name='End date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_page', models.ForeignKey(blank=True, help_text='Choose either Related Page, External Link, or Internal link', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailcore.page')),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='cards', to='home.genericpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
