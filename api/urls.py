...
_urlpatterns = [
    ...
    path(r'datasets/<dsid>/filesearch/files/cyclone_fix/', views.filesearch_files_cyclone_fix),
    path(r'datasets/<dsid>/filesearch/files/grid/', views.filesearch_files_grid),
    path(r'datasets/<dsid>/filesearch/files/sensor/', views.filesearch_files_sensor),
