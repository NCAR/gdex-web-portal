...
(function () {
    ...
    (function () {
        ...
        /* Data lives in gdex_geo_data.js (loaded before this file) so   */
        /* the classification logic below isn't buried in country lists. */

        var geo         = window.GDEX_GEO || {};
        var US_STATES   = geo.US_STATES   || {};
        var CA_PROVS    = geo.CA_PROVS    || {};
        var COUNTRY_CONT = geo.COUNTRY_CONT || {};
        var GCMD_TOP    = geo.GCMD_TOP    || {};
        var CONT_ORDER  = geo.CONT_ORDER  || [];
