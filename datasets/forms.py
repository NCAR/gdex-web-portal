...
class DatasetRequestForm(forms.Form):
    ...
    dsid = forms.CharField(max_length=7, required=True, label="dsid", help_text="Dataset ID")
    gindex = forms.IntegerField(required=True, initial=0, label="gindex", help_text="Group Index")
