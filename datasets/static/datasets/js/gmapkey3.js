...
if (typeof gmap3_loaded != "undefined" && !gmap3_loaded) {
  const gmap_api_key = JSON.parse(document.getElementById('gmap_api_key').textContent);
  const gmap_api_url = JSON.parse(document.getElementById('gmap_api_url').textContent);
